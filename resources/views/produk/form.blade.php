            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- <div class="form-group row">
                        <label for="barcode_produk" class="col-lg-2 col-lg-offset-1 control-label">Code</label>
                        <div class="col-lg-6">
                            <input type="text" name="barcode_produk" id="barcode_produk" class="form-control" autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="number" name="harga_beli" id="harga_beli" class="form-control" step=".01" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="number" name="harga_jual" id="harga_jual" class="form-control" step=".01" required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="stok" class="col-lg-2 col-lg-offset-1 control-label">Minimum Stock</label>
                        <div class="col-lg-6">
                            <input type="number" name="min_stok" id="min_stok" class="form-control" required value="0">
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
