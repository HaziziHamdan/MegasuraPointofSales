    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('total_harga', function ($pembelian) {
                return 'RM '. format_uang($pembelian->total_harga);
            })
            ->addColumn('bayar', function ($pembelian) {
                return 'RM '. format_uang($pembelian->bayar);
            })
            ->addColumn('tanggal', function ($pembelian) {
                return malaysian_time($pembelian->created_at, false);
            })
    ...
    public function show($id)
    {
        ...
        return datatables()
            ...
            ->addColumn('harga_beli', function ($detail) {
                return 'RM '. format_uang($detail->harga_beli);
            })
