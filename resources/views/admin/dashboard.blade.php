    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Income Chart {{ malaysian_time($tanggal_awal, false) }} - {{ malaysian_time($tanggal_akhir, false) }}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
...
$(function() {
    ...
    profitChart.Line(profitChartData, profitChartOptions);
});
</script>
@endpush